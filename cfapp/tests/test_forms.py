...
class TestTransazioneForm(TestCase):
    def setUp(self):
        self.tipologia_transazione1 = TipologiaTransazione.objects.create(tipologia_transazione="Transazione 1")
        self.tipologia_transazione2 = TipologiaTransazione.objects.create(tipologia_transazione="Transazione 2")
        ...
        self.committente1 = Committenti.objects.create(codice="ABC", committente="Committente 1")
        self.committente2 = Committenti.objects.create(codice="DEF", committente="Committente 2")
        ...
        self.incasso1 = Incasso.objects.create(
            importo=100, data="2023-01-01", ricevuta="123456", canale=self.canale1, committente=self.committente1
        )
        self.incasso2 = Incasso.objects.create(
            importo=200, data="2023-02-01", ricevuta="789012", canale=self.canale2, committente=self.committente2
        )
...
class TestIncassoForm(TestCase):
    ...
    def test_incasso_form_valid(self):
        ...
        self.assertCountEqual(incasso.transazioni.all(), [self.transazione1, self.transazione2])
